...
@app.route('/')
def index():
    return 'Streaks with Todoist: Click <a href=' + url + '>here</a> to connect your account./n/n Visit our <a href=https://github.com/briankaemingk/streaks-with-todoist>Github page</a> for more info or to submit a bug.'

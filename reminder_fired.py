...
def main(api, task_id):
    ...
    now_date = app.utils.get_now_user_timezone(api)
    now_date_all_day = app.utils.update_to_all_day(now_date)
    now_string_all_day = app.utils.convert_datetime_str(now_date_all_day)
